...
def translate_speech_to_speech():  
    ...
    # Starts translation, and returns after a single utterance are recognized. The end of a  
    # single utterance is determined by listening for silence at the end or until a maximum of 15  
    # seconds of audio are processed. It returns the recognized text as well as the translation.  
    ...
    if result.reason == speechsdk.ResultReason.TranslatedSpeech:  
        ...
        if key == "fr":  speech_config.speech_synthesis_voice_name = "fr-FR-Julie-Apollo"  # Update the speech synthesizer to use the proper voice  speech_synthesizer = speechsdk.SpeechSynthesizer(speech_config=speech_config)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            print("TRANSLATED into {}: {}".format(key, result.translations[key]))  # If the language code is 'fr' for French, then use the French voice for Julie  # If you change the languages in the 'AddTargetLanguage' above, ensure you modify this if statement as well  if key == "fr":  speech_config.speech_synthesis_voice_name = "fr-FR-Julie-Apollo"  # Update the speech synthesizer to use the proper voice  speech_synthesizer = speechsdk.SpeechSynthesizer(speech_config=speech_config)
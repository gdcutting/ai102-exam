...
# Lab 3-07: Translate speech in multiple target languages
...
def translate_speech_to_speech():  
    ...
    # Note: Since recognize_once() returns only a single utterance, it is suitable only for single  # shot recognition like command or query.

...
def translate_speech_to_text():  
    ...
    # Starts translation, and returns after a single utterance are recognized. 
    # The end of a  # single utterance is determined by listening for silence at the end or until a maximum of 15  
